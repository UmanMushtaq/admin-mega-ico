        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-8 col-xl-7 text-center">
              ...
              <p className="large">
                We care our customer privacy' &amp; inside content remove
                  ...
                  <div className="card-text">
                    <p>
                      <strong>
                        ...
                        with that data. This Privacy Policy for softNio
                      </strong>
                    </p>
                    <p>
                      ...
                      <a href="http://demo.themenio.com/ico">
                        http://demo.themenio.com/ico
                      </a>
                    </p>
                    <h5>
                    ...
                    <p>
                      Every legitimate project that sources funds through an ICO
                      has a website, where they specify what the project is all
                      about, its goals, the amount of money needed, how long the
                      funding campaign will go on for and so forth.
                    </p>
                    <h5>
